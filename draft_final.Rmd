...
title(main = "Birds seen by height", cex.main=0.8, font.main= 3, col.main = "gray50", line = 0.5)
...
title(main = "Birds seen by speed", cex.main=0.8, font.main= 3, col.main = "gray50",line = c(0.5))
#title(xlab="speed", line=4, cex.lab=1.2, family="Calibri Light")
